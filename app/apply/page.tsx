...
export default function ApplyPage() {
  ...
  function canDisplayDataUrl(dataUrl: string): Promise<boolean> {
  ...
  async function onFilesSelected(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    for (const f of incoming) {
      ...
      if (
        ...
        lastError = "HEIC photos are not supported. Please choose JPG or PNG.";
        continue;
      }
      ...
      try {
        ...
        const ok = await canDisplayDataUrl(dataUrl);
        if (!ok) {
          lastError =
            "That photo could not be displayed. Try JPG or PNG from Gallery.";
          continue;
        }
        ...
        lastError = "Could not load that photo. Try JPG or PNG.";
      }
    }
  ...
  async function submitApplication() {
    ...
    let avatarUrl: string | null =
      avatarUploadedUrl || existingAvatarUrl || null;
    let avatarWarning = "";
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-2">
            Your profile is under review. We will contact you to schedule a
            short in-person verification (ID + suitability check). Only after
            that meeting do you appear as Verified for clients.
          </p>
        </div>
    ...
    <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Show your skills and proof of work. We review your ID and meet you
          in person before approval — so clients can trust the directory,
          including for work inside homes.
        </p>
      </div>
      ...
      <div className="rounded-xl border bg-white p-6 space-y-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                ) : avatarUploadedUrl || avatarPreview ? (
                  "Change photo"
                ) : (
                  "Add photo"
                )}
        ...
        <div>
          ...
          <input
            type="tel"
            placeholder="e.g. 87 770 0011 or +220 87 770 0011"
            value={whatsapp}
        ...
        <div>
          ...
          {selectedSkills.filter((s) => !(SKILLS as readonly string[]).includes(s)).length > 0 && (
            <div className="flex flex-wrap gap-1.5 mt-2">
              {selectedSkills
                .filter((s) => !(SKILLS as readonly string[]).includes(s))
                .map((s) => (
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-2">
            Photos of jobs you have finished help us verify you faster. Up to 6
            images, max 5MB each.
          </p>
          <input
            ref={fileInputRef}
        ...
        <label className="flex items-start gap-3 rounded-lg border bg-gray-50 p-3 cursor-pointer">
          ...
          <span className="text-sm text-gray-700">
            ...
            will review my national ID and complete an in-person assessment
            before approval.
          </span>
        </label>
