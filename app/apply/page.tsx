...
export default function ApplyPage() {
  ...
  function isImageFile(f: File) {
    ...
    // Android / Google Photos often returns empty MIME
  ...
  async function onFilesSelected(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setPreviews((prev) => [...prev, ...dataUrls].slice(0, MAX_FILES));
    } catch (err: any) {
      console.error("Proof preview failed:", err);
      setError("Could not load one of the photos. Try JPG or PNG.");
    }
  }
