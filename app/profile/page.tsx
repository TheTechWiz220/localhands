      ...
      <div className="rounded-xl border bg-white p-6 space-y-4">
              ...
              {nameLocked ? (
                <>
                  ...
                  <p className="text-[11px] text-gray-500 mt-1">
                    Name is locked after verification. Contact admin to change it.
                  </p>
                </>
              ) : (
                <input
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <input
                      ...
                      className="flex-1 px-2 py-1.5 rounded-lg border text-sm bg-white"
                    />
        ...
        {isWorker && status === "pending" && (
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
            Your worker application is under review. We will contact you for in-person verification.
          </div>
        )}
        ...
        {isWorker && (
          <div className="space-y-3 pt-2 border-t">
            ...
            <Button
              ...
              variant="outline"
              className="w-full"
              disabled={uploading || proofItems.length >= MAX_FILES}
