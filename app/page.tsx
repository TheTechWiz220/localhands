    ...
    <div className="flex flex-col">
      <section className="bg-gradient-to-b from-green-600 to-green-700 text-white px-4 py-12">
        <div className="max-w-lg mx-auto text-center space-y-6">
          <h1 className="text-3xl font-bold leading-tight">
            Verified Skills.<br />Real Work.<br />LocalHands.
          </h1>
          <p className="text-green-100 text-lg">
            Find trusted skilled workers across The Gambia.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            ...
            <Link href="/apply">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-white text-white hover:bg-green-600"
              >
                I Have Skills
              </Button>
            </Link>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Every worker is reviewed with real proof of work.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-lg">Local to You</h3>
            <p className="text-sm text-gray-600">
              Kololi, Brusubi, Brikama, Basse and more.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-lg">Urban & Rural</h3>
            <p className="text-sm text-gray-600">
              Phone repair, solar, farm labour, construction...
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-12 max-w-lg mx-auto text-center">
        ...
        <p className="text-gray-600 mb-6">
          Join LocalHands and start receiving job requests.
        </p>
        <Link href="/apply">
          <Button size="lg">Apply as Worker</Button>
        </Link>
      </section>
    </div>
  );
